...
def Inference(FLAGS):
    ...
    net = BLGNet(in_chns=1, class_num=4).cuda()
    ...
    avg_dice = (avg_metric[0][0] + avg_metric[1][0] + avg_metric[2][0]) / 3
    avg_jc = (avg_metric[0][1] + avg_metric[1][1] + avg_metric[2][1]) / 3
    avg_hd95 = (avg_metric[0][2] + avg_metric[1][2] + avg_metric[2][2]) / 3
    avg_asd = (avg_metric[0][3] + avg_metric[1][3] + avg_metric[2][3]) / 3
